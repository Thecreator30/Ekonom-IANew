...
const Coupons: React.FC = () => {
  return (
    <div className="px-5 pt-8 pb-24 animate-fade-in text-gray-900 dark:text-white">
      {/* Header */}
      <header className="flex justify-between items-center mb-8">
        ...
        <button className="w-10 h-10 rounded-full bg-white dark:bg-white/5 shadow-sm border border-gray-200 dark:border-white/10 flex items-center justify-center text-gray-600 dark:text-gray-300 relative hover:bg-gray-50 dark:hover:bg-white/10 transition">
          <Bell size={20} />
      ...
      <div className="space-y-4">
        ...
        <div className="relative group cursor-pointer">
            ...
            <div className="relative bg-white dark:bg-[#1A1F2E] rounded-2xl border border-gray-100 dark:border-white/5 overflow-hidden flex">
                {/* Left Side (Visual) */}
                <div className="w-24 bg-gradient-to-br from-purple-500 to-indigo-600 flex flex-col items-center justify-center text-white p-2 relative">
                ...
                <div className="flex-1 p-4 flex flex-col justify-between">
                    <div className="flex justify-between items-start mb-2">
                        <div>
                            <h3 className="font-bold text-gray-900 dark:text-white">WELCOME20</h3>
                            <p className="text-xs text-gray-500">Offre de bienvenue</p>
                        </div>
                        <span className="px-2 py-0.5 bg-green-500/10 text-green-500 text-[10px] font-bold uppercase rounded-md border border-green-500/20">Actif</span>
                    </div>
        ...
        <div className="relative opacity-70 hover:opacity-100 transition duration-300 cursor-pointer">
             <div className="relative bg-white dark:bg-[#1A1F2E] rounded-2xl border border-gray-100 dark:border-white/5 overflow-hidden flex">
                <div className="w-24 bg-gray-200 dark:bg-white/5 flex flex-col items-center justify-center text-gray-400 dark:text-gray-500 p-2 relative">
                    <div className="absolute -left-2 top-1/2 -translate-y-1/2 w-4 h-4 bg-background-light dark:bg-background-dark rounded-full"></div>
                ...
                <div className="flex-1 p-4 flex flex-col justify-between">
                    <div className="flex justify-between items-start mb-2">
                        <div>
                            <h3 className="font-bold text-gray-900 dark:text-white">SUMMER50</h3>
                            <p className="text-xs text-gray-500">Soldes d'été</p>
                        </div>
                        <span className="px-2 py-0.5 bg-gray-100 dark:bg-white/10 text-gray-400 text-[10px] font-bold uppercase rounded-md">Expiré</span>
                    </div>
